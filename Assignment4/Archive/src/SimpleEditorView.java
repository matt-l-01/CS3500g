...
public class SimpleEditorView implements ImageEditorView {
  ...
  /**
   * Constructs a SimpleEditorView. Because no output was provided, defaults to System.out.
  ...
  /**
   * Constructs a SimpleEditorView using the given output destination. Then instantiates
